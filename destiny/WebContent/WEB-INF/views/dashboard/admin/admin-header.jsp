                      ...
                      <li class="headerlist"><a href="/destiny/admin-fundraisers" class="white ad-menu-1 shop-menu" style="text-decoration:none; cursor: pointer;">Fundraisers</a>
                        <!--<ul class="dropdown-content user-menu3 contact-menu2" style="list-style-type:none; position: absolute;">
                          <div class="ad-second1" style="display: block">
                              ...
                              <a class="internalmenu" href="ngo-fundraisers.jsp" style="text-decoration:none"><li class="padding"> NGO</li></a>
                          </div>  
                        </ul>-->
                      </li>
                      ...
                      <li class="headerlist"><a href="/destiny/admin-campaign" class="white ad-menu-2 shop-menu" style="text-decoration:none; cursor: pointer;">Campaigns</a>
                        <!--<ul class="dropdown-content user-menu4 contact-menu2" style="list-style-type:none; position: absolute">
                          <div class="ad-second2" style="display: block">
                              ...
                              <a class="internalmenu" href="charity_ngo-campaign.jsp" style="text-decoration:none"><li class="padding"> CHARITY / NGO</li></a>
                          </div>  
                        </ul>-->
                      </li>       

                      <li class="headerlist"><a href="/destiny/admin-withdraw-request" class="white events-menu" style="text-decoration:none; cursor: pointer;">Withdraw Request</a>
                      </li>
...
//fundraisers And Campaigns menus


$(".ad-menu-1").click(function(){
var a1=$(".user-menu3").css('display');
...
$(".ad-menu-2").click(function(){
var a2=$(".user-menu4").css('display');
...
<div class="first" style="display: none">
      <a class="internalmenu" href="login.jsp" style="text-decoration:none"><li class="padding"><i class="fa fa-sign-in"></i> Login</li></a>
      <a class="internalmenu" href="start-a-fundraisers.jsp" style="text-decoration:none"><li class="padding"><i class="fa fa-user-plus"></i> Sign Up</li></a>
</div>      
...
<a href="admin-profile" style="text-decoration: none;"><span class="dashboard-profile dh">PROFILE</span></a>
</div>
