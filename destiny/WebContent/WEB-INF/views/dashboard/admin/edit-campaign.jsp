    ...
    transition: 0.3s;
        ...
        */
         ...
         .slick-dots li.slick-active
        {
            ...
            {
                border-radius: 100px;
                cursor: url("/destiny/files/dashboard-admin-images/delete2.png"), default;
                width:110px; 
                height: 110px;
            }
...
<div class="edit-image1">
    <span class="uploaded-iamges">
            <img src="/destiny/files/dashboard-admin-images/donor3.svg" class="edit-img2">
            <img src="/destiny/files/dashboard-admin-images/donor2.svg" class="edit-img2">
            <img src="/destiny/files/dashboard-admin-images/donor1.svg" class="edit-img2">
            <img src="/destiny/files/dashboard-admin-images/donorall.png" class="edit-img2">
    </span>
<span class="upload-iamges">
        <img src="/destiny/files/dashboard-admin-images/media2.png" class="add-images2">
...
<span class="edit-bn-image1">
    <img src="/destiny/files/dashboard-admin-images/camera1.png" class="cam-img1">
</span>
...
<span class="new-document">     
    <img src="/destiny/files/dashboard-admin-images/upload-document.png" style="border:none;" class="document-details upload-doc">
        ...
        <hr style="border: solid 0.5px black; margin-top: -2px;">
            <div class="col-md-6">
                ...
                <span class="edit-upi-image">
                    <img src="/destiny/files/dashboard-admin-images/camera1.png" class="upi-image">
