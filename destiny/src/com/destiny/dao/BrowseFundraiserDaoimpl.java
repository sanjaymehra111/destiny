...
public class BrowseFundraiserDaoimpl
{
	...
	public List<CampaignsModel> FetchSuccessCampaignsDetails(int index)
	{
		List<CampaignsModel> query2 = template.query("select * from campaign_details where fundraisers_status = 2 order by fundraisers_campaign_success_date desc limit 0,"+index+" ", new RowMapper<CampaignsModel>()
				{
