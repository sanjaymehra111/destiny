...
public String getPersonal_updated_date() {
	return personal_updated_date;
}



public void setPersonal_updated_date(String personal_updated_date) {
	this.personal_updated_date = personal_updated_date;
}
...
public String toString() {
	...
	builder.append("FundraiserModel [fundraisers_id=").append(fundraisers_id).append(", category_type=")
			...
			.append(", personal_profile_image=").append(personal_profile_image).append(", personal_updated_date=")
			.append(personal_updated_date).append(", personal_status=").append(personal_status).append("]");
...
public FundraiserModel(String fundraisers_id, String category_type, String personal_name, String personal_email,
		...
		String personal_aadhar_no, String personal_dob, String personal_profile_image, String personal_updated_date,
		String personal_status) {
	super();
	this.fundraisers_id = fundraisers_id;
	this.category_type = category_type;
