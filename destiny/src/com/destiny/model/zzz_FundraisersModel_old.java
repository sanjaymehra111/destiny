...
public zzz_FundraisersModel_old()
{
	...
	public String toString() {
		...
		builder.append("FundraisersModel [fundraisers_id=").append(fundraisers_id).append(", category_type=")
				...
				.append(", fundraisers_title=").append(fundraisers_title).append(", fundraisers_goal_amount=")
				.append(fundraisers_goal_amount).append(", fundraisers_name=").append(fundraisers_name)
				.append(", fundraisers_contact=").append(fundraisers_contact).append(", fundraisers_email=")
				.append(fundraisers_email).append(", fundraisers_beneficiary_relation=")
